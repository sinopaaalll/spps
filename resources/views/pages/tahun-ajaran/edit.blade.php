...
@section('breadcrumb-text', 'Edit Tahun Ajaran')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tahun_awal') is-invalid @enderror"
                                        id="tahun_awal" name="tahun_awal" value="{{ $tahun_ajaran->tahun_awal }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tahun_akhir') is-invalid @enderror"
                                        id="tahun_akhir" name="tahun_akhir" value="{{ $tahun_ajaran->tahun_akhir }}"
                                        readonly>
                                    @error('tahun_akhir')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    @foreach ($status as $key => $item)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status"
                                                ...
                                                {{ $item == $tahun_ajaran->status ? 'checked' : '' }}>
